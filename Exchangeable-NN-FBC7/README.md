This is the code repository for the paper "Exchangeability in Neural Network Architectures and its Application to Dynamic Pruning" in submission to NeurIPS 2025.
